...
use crate::{errors::ParseResult, RholangParser};
...
#[no_mangle]
pub extern "system" fn Java_org_rholang_lang_parser_RholangParserJNI_isValidNative(
    mut env: JNIEnv,
    _class: JClass,
    code: JString,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_org_rholang_lang_parser_RholangParserJNI_parseNative(
    mut env: JNIEnv,
    _class: JClass,
    code: JString,
) -> jstring {
